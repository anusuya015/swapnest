...
const ProductScreen = ({ match, history }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // Step 1: Create Order
      const { data } = await axios.post("https://swapnest-backend.onrender.com/payment/create-order", {
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
           ...
           const { data } = await axios.post("https://swapnest-backend.onrender.com/payment/verify", {
